...
#define  MQTT_TxData(x)       u3_TxData(x)                                         //串口2负责数据发送

#define Identifier           "LightStatus"

#define  PRODUCTKEY           "a1tYRSP3F61"                                        //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                                   //产品ID长度
#define  DEVICENAME           "DLCS"                                               //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                                   //设备名长度
#define  DEVICESECRE          "231118872f0fcf7bdbd64d794741c577"                   //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                                  //设备秘钥长度

#define  S_TOPIC_NAME         "/sys/a1tYRSP3F61/DLCS/thing/service/property/set"   //需要订阅的主题  

#define  P_TOPIC_NAME         "/sys/a1tYRSP3F61/DLCS/thing/event/property/post"    //需要发布的主题     
